...
class ResNet18(nn.Module):
    ...
    def __init__(self, num_classes=1000, pretrained=False):
        ...
        # Load the ResNet18 model with the specified parameters
...
class _TestResNet18(unittest.TestCase):
    def test_resnet18_initialization(self):
        # Test with default parameters
        model = ResNet18()
        self.assertIsInstance(model, ResNet18, "Model is not an instance of ResNet18")
