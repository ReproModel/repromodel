...
class DeepLabV3MobileNetV3Large(nn.Module):
    ...
    def __init__(self, num_classes=21, pretrained=False):
        super(DeepLabV3MobileNetV3Large, self).__init__()
...
class _TestDeepLabV3MobileNetV3Large(unittest.TestCase):
    def test_deeplabv3_mobilenet_v3_large_initialization(self):
        ...
        model = DeepLabV3MobileNetV3Large()
        self.assertIsInstance(model, DeepLabV3MobileNetV3Large, "Model is not an instance of DeepLabV3MobileNetV3Large")
