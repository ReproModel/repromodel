...
import dummytrainConfig from "../../../repromodel_core/DummyDemoTrainer.json"
    ...
    <div className = "modal-container">
      ...
      <Modal open = { open } onClose = { handleClose }>
        ...
        <Box className = "modal">
          ...
          <Button variant = "contained" className = "modal-button" onClick = { () => handleDownload(dummytrainConfig, 'DemoTrainingConfig', 'json') }>
            Download
          </Button>
