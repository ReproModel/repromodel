    ...
    return (
        <Form className = "tab-container">
            ...
            <div className = "github-button">
                <Button variant = "contained" onClick = { () => pushGithub(personalAccessToken, repositoryName, repositoryDescription, visibility) } style = { { marginTop: "12px", backgroundColor: "#38512f", opacity: "90%", width: "150px" } }>
