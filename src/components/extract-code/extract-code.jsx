    ...
    return (
        <Form className = "tab-container">
            ...
            <div className = "code-extractor-button">
                <Button variant = "contained" onClick = { extractCode } style = { { marginTop: "12px" } } disabled = { !confirmationOne || !confirmationTwo }>
            ...
            <div className = "github-button">
                <Button variant = "contained" onClick = { () => pushGithub(personalAccessToken, repositoryName, repositoryDescription, visibility) } style = { { marginTop: "12px" } }>
