                  ...
                  >
                    ...
                    >
                      <Button
                        ...
                        onClick={() => setSelectedSection("Custom Script")}
                      >
                        Custom Script
                      </Button>
                      <Button
                      ...
                      <Button
                        onClick={() => setSelectedSection("Model Testing")}
                        style={{
                          fontSize: "12px",
                          width: "20%",
                          opacity:
                            selectedSection == "Model Testing" ? "100%" : "70%",
                        }}
                      >
                        Model Testing
                      </Button>
                      <Button
                        onClick={() => setSelectedSection("Progress Viewer")}
                        style={{
                          fontSize: "12px",
                          width: "20%",
                          opacity:
                      ...
                      <Button
                        onClick={() => setSelectedSection("Extract Code")}
                        style={{
                          fontSize: "12px",
                          width: "20%",
                          opacity:
                            selectedSection == "Extract Code" ? "100%" : "70%",
                        }}
                      >
                        Extract Code
                      </Button>
                      <Button
                        onClick={() => setSelectedSection("LLM Description")}
                        style={{
                          fontSize: "12px",
                          width: "20%",
                          opacity:
