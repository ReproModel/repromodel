...
The current prototype helps researchers to modularize their development and compare the performance of <strong>each step in the pipeline in a reproducible way</strong>. The prototype version helped us reduce the time for model development, computation, and writing by at least 40%.

The following versions will help researchers to build upon state-of-the-art research faster by just <strong>loading the previously published study ID</strong>. All code, experiments, and results would already be verified, and stored in the system.
